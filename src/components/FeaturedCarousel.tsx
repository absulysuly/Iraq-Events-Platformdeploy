...
export const FeaturedCarousel: React.FC<FeaturedCarouselProps> = ({ events, lang, onSelectEvent, bookmarkedEventIds, onToggleBookmark }) => {
  ...
  }, [currentIndex, isDragging, startTimer, events.length]);
    ...
    >
      ...
      >
        {events.map((event) => (
          ...
          >
            <LazyImage src={event.imageUrl} alt={event.title[lang] || event.title.en} className="w-full h-full" />
