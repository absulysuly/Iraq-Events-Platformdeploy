...
// FIX: Updated lazy loading to correctly import modules with default exports.
...
const App: React.FC = () => {
    ...
    const handleOAuthLogin = async (provider: 'google' | 'facebook') => {
        try {
            ...
            // Supabase handles the callback and the onAuthStateChange listener will update the user state.
        } catch (error) {
