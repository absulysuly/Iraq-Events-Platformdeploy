...
// FIX: Changed lazy loaded components to use default exports to fix prop-typing errors.
...
const AIItineraryModal = lazy(() => import('./components/AIItineraryModal'));
...
const App: React.FC = () => {
    ...
    const handleOAuthLogin = async (provider: 'google' | 'facebook') => {
        try {
            ...
            // The user will be redirected. Supabase handles the callback, 
            // and the onAuthStateChange listener will update the user state and close the modal.
        } catch (error) {
            console.error(`${provider} login failed:`, error);
            addToast(`Failed to sign in with ${provider}. Please try again.`, 'error');
            // Re-throw to allow the modal to handle its loading state
            throw error;
        }
    };
